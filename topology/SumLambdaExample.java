 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.2.1-standalone.jar io.confluent.examples.streams.SumLambdaExample
 * }
 * </pre>
 ...
 * $ java -cp target/kafka-streams-examples-5.2.1-standalone.jar io.confluent.examples.streams.SumLambdaExampleDriver
 * }
 * </pre>
...
public class SumLambdaExample {
    ...
    private static final Logger logger = Logger.getLogger(SumLambdaExample.class);
    ...
    static Topology getTopology() {
        ...
        final KStream<Void, Integer> input = builder.stream(CONFIRMATION_AUTHORIZATION_TOPIC);
